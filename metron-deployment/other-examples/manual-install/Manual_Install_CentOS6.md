...
Install bro:
```
# wget -O /tmp/bro-2.5.2.tar.gz https://www.bro.org/downloads/bro-2.5.2.tar.gz
# /bin/gtar --extract -C /tmp -z -f /tmp/bro-2.5.2.tar.gz
# cd /tmp/bro-2.5.2
...
# rm -rf build/
# ./configure --bro-dist=/tmp/bro-2.5.2 --install-root=/usr/local/bro/lib/bro/plugins/ --with-librdkafka=/usr/local
# make -j4
# make install
```
